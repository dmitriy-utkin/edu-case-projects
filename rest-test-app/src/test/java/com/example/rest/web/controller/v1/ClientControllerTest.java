...
public class ClientControllerTest extends AbstractTestController {
    ...
    @Test
    public void findAll_thenReturnAllClients() throws Exception {
        ...
        String expectedResponse = StringTestUtils
                .readStringFromResource("response/client/find_all_clients_response.json");
    ...
    public void whenGetClientById_thenReturnClientById() throws Exception {
        ...
        String actualResponse = mockMvc.perform(get("/api/v1/client/1"))
                ...
                .getContentAsString();
        String expectedResponse = StringTestUtils
                .readStringFromResource("response/client/find_client_by_id_response.json");
    ...
    public void whenCreateClient_thenReturnNewClient() throws Exception {
        ...
        String actualResponse = mockMvc.perform(post("/api/v1/client")
                ...
                .getContentAsString();
        String expectedResponse = StringTestUtils
                .readStringFromResource("response/client/create_client_response.json");
    ...
    @Test
    public void whenUpdateClient_thanReturnUpdatedClient() throws Exception {
        ...
        String actualResponse = mockMvc.perform(put("/api/v1/client/1")
                ...
                .getContentAsString();
        String expectedResponse = StringTestUtils
                .readStringFromResource("response/client/update_client_response.json");
...
//          Option with @ResponseStatus(HttpStatus.NOT_FOUND) for Error Class
...
//                .andExpect(status().isNotFound());
        ...
        String expectedResponse = StringTestUtils
                .readStringFromResource("response/client/client_by_id_not_found_response.json");
    ...
    public void whenCreateClientWithEmptyName_thenReturnError() throws Exception {
        ...
        String actualResponse = response.getContentAsString();
        String expectedResponse = StringTestUtils
                .readStringFromResource("response/client/empty_client_name_response.json");
    ...
    public void whenCreateClientWithInvalidSizeName_thenReturnError(String name) throws Exception {
        ...
        String actualResponse = response.getContentAsString();
        String expectedResponse = StringTestUtils
                .readStringFromResource("response/client/client_name_size_exception_response.json");
